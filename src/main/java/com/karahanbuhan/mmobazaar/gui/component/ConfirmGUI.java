...
public class ConfirmGUI implements ClickableGUI, BazaarGUI {
    ...
    public Inventory getInventory(Player player) {
        Inventory gui = Bukkit.createInventory(null, 9, context.localization.get(TranslationKey.GUI_CONFIRM_TITLE, listing.getPrice()));

        // TODO Continue from adding translation keys.
